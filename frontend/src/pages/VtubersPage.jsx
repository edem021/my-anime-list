  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5">
        {vtubers?.map((vtuber) => {
          const originalSongsCount = vtuber.songs.filter(
            (song) => song.original,
          ).length;
          const coverSongsCount = vtuber.songs.filter(
            (song) => !song.original,
          ).length;
          ...
          return (
            ...
            >
              ...
              {vtuber.songs.length > 0 && (
                <div className="flex flex-col justify-center pr-5 items-end">
                  {originalSongsCount > 0 && (
                    <h3 className="text-base-content/70">
                      {originalSongsCount} original
                    </h3>
                  )}
                  {coverSongsCount > 0 && (
                    <h3 className="text-base-content/70">
                      {coverSongsCount} cover
                    </h3>
                  )}
                </div>
              )}
